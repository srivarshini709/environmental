...
// Fetch doctors for dropdown in the add record form
...
<head>
    ...
    <title>Staff Dashboard - TakeCare Hospital Management System</title>
...
<body>
    <div class="container">
        <div class="sidebar">
            ...
            <a href="appointment_schedule.php">View Appointments</a>
